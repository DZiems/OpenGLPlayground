...
GLuint Utils::loadTexture(const char* texImagePath) {
	...
	if (textureID == 0) {
		cout << "could not find texture file: " << texImagePath << "\n";
	}
...
// JADE
float* Utils::jadeAmbient() { static float a[4] = { 0.135f, 0.2225f, 0.1575, 0.7f }; return (float*)a; }
float* Utils::jadeDiffuse() { static float a[4] = { 0.54f, 0.89f, 0.63f, 0.7f }; return (float*)a; }
float* Utils::jadeSpecular() { static float a[4] = { 0.3162f, 0.3162f, 0.3162f, 0.7 }; return (float*)a; }
